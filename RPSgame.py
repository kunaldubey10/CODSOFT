...
main_frame.pack()
label1=Label(main_frame,text="Stone,Paper,Scissor Game",font=("Aptos", 12))
...
stone_button=ttk.Radiobutton(choose_frame,text="Stone",value="Stone",command=result,variable=choice_var)
stone_button.grid(row=0,column=1,padx=5)
